...
public class addingMoneyController {
    ...
    @FXML
    void initialize() {
        label1.setText("Ваш Депозит " + Service.depositsumadding(anketaController.Sum, anketaController.Term,anketaAddingMoneyController.SUM));
